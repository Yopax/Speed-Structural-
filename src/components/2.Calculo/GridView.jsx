...
const GridView = () => {
  ...
  useEffect(() => {
    // Verifica si hay valores en los arrays columnSizes y rowSizes
    const hasColumnValues = columnSizes.some(size => size !== '');
    const hasRowValues = rowSizes.some(size => size !== '');
    setHasValues(hasColumnValues || hasRowValues);
  }, [columnSizes, rowSizes]);

  return (
    <>
      {hasValues && (
        <div className="flex bg-transparent max-sm:w-full justify-center mx-auto max-sm:mt-4">
          <div className="flex flex-col justify-center items-center mx-auto">
            ...
            <div className="flex w-full justify-center items-center mx-auto">
              <div className="relative justify-center items-center mx-auto">
                ...
                <div className="grid absolute h-[200px] max-sm:h-[130px] items-center max-sm:-left-8 -left-14">
